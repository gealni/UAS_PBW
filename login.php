...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
        <div class="container">
          <a class="navbar-brand" href="tugas.html#">Jurnal Harian</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="text-dark navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="tugas.html#hero">Home</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="tugas.html#article">Article</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tugas.html#gallery">Gallery</a>
                  </li>
                  <li class="nav-item">
                  <a class="nav-link" href="tugas.html#jadwal">Schedule</a>
                </li>
                  <li class="nav-item">
                <a class="nav-link" href="tugas.html#profil">Profil</a>
              </li>
                  <li class="nav-item">
    ...
    <!-- form -->
    <section id="article" class="text-center p-5 bg-light">
  <div class="container">
    <!-- Form Login -->
            ...
            <?php
              if ($_REQUEST) {
                ...
                if ($_POST['user'] == "admin" && $_POST["pass"] == "12345") {
                  echo "<div class='alert alert-success mt-3'>Username dan Password cocok</div>";
                } else {
                  echo "<div class='alert alert-danger mt-3'>Username dan Password tidak cocok</div>";
                }
              }
            ?>
          </div>
