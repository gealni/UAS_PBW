...
<html lang="en">
  ...
  <body>
    ...
    <!--Hero start-->
    <section id="hero" class="p-5 bg-primary-subtle">
      <div class="container">
...
<!-- article end -->
          ...
          <div class="col">
            ...
            <div class="card text-bg-warning mb-3" style="max-width: 18rem;">
              ...
              <div class="card-body text-bg-light">
                ...
                <h7 class="card-title"><b>13:00-15:30</b></h7>
                <h6 class="card-text">Dasar Pemrograman</h6>
                <h6 class="card-text">Ruang H.3.1</h6></div>
            </div>
    ...
    <!--Schedule end-->
    <!-- Profil Start -->
    <section id="profil" class="p-5" style="background-color: #899db1;">
      <div class="container">
        <!-- Heading -->
        <div class="text-center fw-bold display-4 pb-3">
        ...
        <div class="row justify-content-center align-items-center g-4">
          ...
          <div class="col-md-3 d-flex justify-content-center">
            <img
              src="img/Gemma.jpg.jpg"
              class="img-fluid rounded-circle"
              style="width: 200px; height: 200px; object-fit: cover;"
              alt="Foto Profil Gemma Albani"
            />
          </div>
          <!-- Card -->
          <div class="col-md-6 d-flex justify-content-center">
            <div class="card text-bg-light text-center w-100">
              <div class="card-body">
                <h5 class="card-title">Gemma Albani</h5>
                <div class="d-flex flex-column gap-2">
                  <!-- NIM -->
                  <div class="row">
                    <div class="col-4 fw-bold text-end">NIM</div>
                    <div class="col-1 text-center">:</div>
                    <div class="col-7 text-start">A11.2023.15070</div>
                  </div>
                  <!-- Program Studi -->
                  <div class="row">
                    <div class="col-4 fw-bold text-end">Program Studi</div>
                    <div class="col-1 text-center">:</div>
                    <div class="col-7 text-start">Teknik Informatika</div>
                  </div>
                  <!-- Email -->
                  <div class="row">
                    <div class="col-4 fw-bold text-end">Email</div>
                    <div class="col-1 text-center">:</div>
                    <div class="col-7 text-start">111202315070@mhs.dinus.ac.id</div>
                  </div>
                  <!-- Telpon -->
                  <div class="row">
                    <div class="col-4 fw-bold text-end">Telpon</div>
                    <div class="col-1 text-center">:</div>
                    <div class="col-7 text-start">085877538509</div>
                  </div>
                  <!-- Alamat -->
                  <div class="row">
                    <div class="col-4 fw-bold text-end">Alamat</div>
                    <div class="col-1 text-center">:</div>
                    <div class="col-7 text-start">Jl. Abumirodj II No.250</div>
                  </div>
                </div>
              </div>
            </div>
...
<!-- Profil End -->
    ...
    <footer class="text-center p-5">
      ...
      <div>Gemma Albani &copy; 2024</div>
    </footer>
    <!-- /footer -->
